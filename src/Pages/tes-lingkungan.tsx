          ...
          <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
            ...
            <div className="flex gap-3 text-[9px] font-bold justify-center mt-2">
              <span className="flex items-center gap-1 text-slate-600">
                <div className="w-2 h-2 bg-red-600 rounded-sm"></div> Kalimantan
                (Tinggi)
              </span>
              <span className="flex items-center gap-1 text-slate-600">
                <div className="w-2 h-2 bg-amber-400 rounded-sm"></div> Sumatera
                (Stabil)
              </span>
              <span className="flex items-center gap-1 text-slate-600">
          ...
          <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
            ...
            <div className="flex justify-between items-center text-[9px] font-bold mt-2 border-t border-slate-100 pt-2">
              <span className="flex items-center gap-1 text-red-500">
                <div className="w-3 h-0.5 bg-red-500 border-dashed"></div> Tanpa
                Replanting (Naik)
              </span>
              <span className="flex items-center gap-1 text-emerald-600">
                <div className="w-3 h-1 bg-emerald-500"></div> Dengan Replanting
                (Turun)
              </span>
            </div>
          </div>
